...
export default createContentLoader('ja/blog/**/*.md', {
  transform(raw): ja_blogData[] {
    return raw.map(({ url, frontmatter }) => {
      ...
      return {
        ...
        allDates: cleanDates,
        abstract: frontmatter.abstract || frontmatter.description || '無',
        tags: Array.isArray(frontmatter.tags) ? frontmatter.tags : [],
        cover: frontmatter.cover,
        category: url.split('/')[3] || '無',
