...
void main() {
	...
	`}class uu extends Rn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new nu(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new Ci(5,5,5),r=new In({name:"CubemapFromEquirect",uniforms:es(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:Qt,blending:qn});r.uniforms.tEquirect.value=t;const a=new $t(s,r),o=t.minFilter;return t.minFilter===xi&&(t.minFilter=Xt),new wd(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,n=!0,s=!0){const r=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,n,s);e.setRenderTarget(r)}}function Sm(i){let e=new WeakMap,t=new WeakMap,n=null;function s(f,p=!1){return f==null?null:p?a(f):r(f)}function r(f){if(f&&f.isTexture){const p=f.mapping;if(p===Vr||p===Hr)if(e.has(f)){const v=e.get(f).texture;return o(v,f.mapping)}else{const v=f.image;if(v&&v.height>0){const E=new uu(v.height);return E.fromEquirectangularTexture(i,f),e.set(f,E),f.addEventListener("dispose",u),o(E.texture,f.mapping)}else return null}}return f}function a(f){if(f&&f.isTexture){const p=f.mapping,v=p===Vr||p===Hr,E=p===Ti||p===Ki;if(v||E){let _=t.get(f);const g=_!==void 0?_.texture.pmremVersion:0;if(f.isRenderTargetTexture&&f.pmremVersion!==g)return n===null&&(n=new Jl(i)),_=v?n.fromEquirectangular(f,_):n.fromCubemap(f,_),_.texture.pmremVersion=f.pmremVersion,t.set(f,_),_.texture;if(_!==void 0)return _.texture;{const S=f.image;return v&&S&&S.height>0||E&&S&&c(S)?(n===null&&(n=new Jl(i)),_=v?n.fromEquirectangular(f):n.fromCubemap(f),_.texture.pmremVersion=f.pmremVersion,t.set(f,_),f.addEventListener("dispose",d),_.texture):null}}}return f}function o(f,p){return p===Vr?f.mapping=Ti:p===Hr&&(f.mapping=Ki),f}function c(f){let p=0;const v=6;for(let E=0;E<v;E++)f[E]!==void 0&&p++;return p===v}function u(f){const p=f.target;p.removeEventListener("dispose",u);const v=e.get(p);v!==void 0&&(e.delete(p),v.dispose())}function d(f){const p=f.target;p.removeEventListener("dispose",d);const v=t.get(p);v!==void 0&&(t.delete(p),v.dispose())}function m(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:s,dispose:m}}function xm(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const s=i.getExtension(n);return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&Sr("WebGLRenderer: "+n+" extension not supported."),s}}}function bm(i,e,t,n){const s={},r=new WeakMap;function a(m){const f=m.target;f.index!==null&&e.remove(f.index);for(const v in f.attributes)e.remove(f.attributes[v]);f.removeEventListener("dispose",a),delete s[f.id];const p=r.get(f);p&&(e.remove(p),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function o(m,f){return s[f.id]===!0||(f.addEventListener("dispose",a),s[f.id]=!0,t.memory.geometries++),f}function c(m){const f=m.attributes;for(const p in f)e.update(f[p],i.ARRAY_BUFFER)}function u(m){const f=[],p=m.index,v=m.attributes.position;let E=0;if(v===void 0)return;if(p!==null){const S=p.array;E=p.version;for(let w=0,A=S.length;w<A;w+=3){const L=S[w+0],I=S[w+1],U=S[w+2];f.push(L,I,I,U,U,L)}}else{const S=v.array;E=v.version;for(let w=0,A=S.length/3-1;w<A;w+=3){const L=w+0,I=w+1,U=w+2;f.push(L,I,I,U,U,L)}}const _=new(v.count>=65535?tu:eu)(f,1);_.version=E;const g=r.get(m);g&&e.remove(g),r.set(m,_)}function d(m){const f=r.get(m);if(f){const p=m.index;p!==null&&f.version<p.version&&u(m)}else u(m);return r.get(m)}return{get:o,update:c,getWireframeAttribute:d}}function Em(i,e,t){let n;function s(f){n=f}let r,a;function o(f){r=f.type,a=f.bytesPerElement}function c(f,p){i.drawElements(n,p,r,f*a),t.update(p,n,1)}function u(f,p,v){v!==0&&(i.drawElementsInstanced(n,p,r,f*a,v),t.update(p,n,v))}function d(f,p,v){if(v===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,r,f,0,v);let _=0;for(let g=0;g<v;g++)_+=p[g];t.update(_,n,1)}function m(f,p,v,E){if(v===0)return;const _=e.get("WEBGL_multi_draw");if(_===null)for(let g=0;g<f.length;g++)u(f[g]/a,p[g],E[g]);else{_.multiDrawElementsInstancedWEBGL(n,p,0,r,f,0,E,0,v);let g=0;for(let S=0;S<v;S++)g+=p[S]*E[S];t.update(g,n,1)}}this.setMode=s,this.setIndex=o,this.render=c,this.renderInstances=u,this.renderMultiDraw=d,this.renderMultiDrawInstances=m}function Tm(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:ot("WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function wm(i,e,t){const n=new WeakMap,s=new wt;function r(a,o,c){const u=a.morphTargetInfluences,d=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,m=d!==void 0?d.length:0;let f=n.get(o);if(f===void 0||f.count!==m){let p=function(){x.dispose(),n.delete(o),o.removeEventListener("dispose",p)};f!==void 0&&f.texture.dispose();const v=o.morphAttributes.position!==void 0,E=o.morphAttributes.normal!==void 0,_=o.morphAttributes.color!==void 0,g=o.morphAttributes.position||[],S=o.morphAttributes.normal||[],w=o.morphAttributes.color||[];let A=0;v===!0&&(A=1),E===!0&&(A=2),_===!0&&(A=3);let L=o.attributes.position.count*A,I=1;L>e.maxTextureSize&&(I=Math.ceil(L/e.maxTextureSize),L=e.maxTextureSize);const U=new Float32Array(L*I*4*m),x=new Jc(U,L,I,m);x.type=En,x.needsUpdate=!0;const R=A*4;for(let Q=0;Q<m;Q++){const F=g[Q],Y=S[Q],J=w[Q],ne=L*I*4*Q;for(let K=0;K<F.count;K++){const Z=K*R;v===!0&&(s.fromBufferAttribute(F,K),U[ne+Z+0]=s.x,U[ne+Z+1]=s.y,U[ne+Z+2]=s.z,U[ne+Z+3]=0),E===!0&&(s.fromBufferAttribute(Y,K),U[ne+Z+4]=s.x,U[ne+Z+5]=s.y,U[ne+Z+6]=s.z,U[ne+Z+7]=0),_===!0&&(s.fromBufferAttribute(J,K),U[ne+Z+8]=s.x,U[ne+Z+9]=s.y,U[ne+Z+10]=s.z,U[ne+Z+11]=J.itemSize===4?s.w:1)}}f={count:m,texture:x,size:new He(L,I)},n.set(o,f),o.addEventListener("dispose",p)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let p=0;for(let E=0;E<u.length;E++)p+=u[E];const v=o.morphTargetsRelative?1:1-p;c.getUniforms().setValue(i,"morphTargetBaseInfluence",v),c.getUniforms().setValue(i,"morphTargetInfluences",u)}c.getUniforms().setValue(i,"morphTargetsTexture",f.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:r}}function Am(i,e,t,n,s){let r=new WeakMap;function a(u){const d=s.render.frame,m=u.geometry,f=e.get(u,m);if(r.get(f)!==d&&(e.update(f),r.set(f,d)),u.isInstancedMesh&&(u.hasEventListener("dispose",c)===!1&&u.addEventListener("dispose",c),r.get(u)!==d&&(t.update(u.instanceMatrix,i.ARRAY_BUFFER),u.instanceColor!==null&&t.update(u.instanceColor,i.ARRAY_BUFFER),r.set(u,d))),u.isSkinnedMesh){const p=u.skeleton;r.get(p)!==d&&(p.update(),r.set(p,d))}return f}function o(){r=new WeakMap}function c(u){const d=u.target;d.removeEventListener("dispose",c),n.releaseStatesOfObject(d),t.remove(d.instanceMatrix),d.instanceColor!==null&&t.remove(d.instanceColor)}return{update:a,dispose:o}}const Rm={[Fc]:"LINEAR_TONE_MAPPING",[Oc]:"REINHARD_TONE_MAPPING",[Bc]:"CINEON_TONE_MAPPING",[kc]:"ACES_FILMIC_TONE_MAPPING",[Vc]:"AGX_TONE_MAPPING",[Hc]:"NEUTRAL_TONE_MAPPING",[zc]:"CUSTOM_TONE_MAPPING"};function Cm(i,e,t,n,s){const r=new Rn(e,t,{type:i,depthBuffer:n,stencilBuffer:s}),a=new Rn(e,t,{type:Zn,depthBuffer:!1,stencilBuffer:!1}),o=new qt;o.setAttribute("position",new Ut([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new Ut([0,2,0,0,2,0],2));const c=new gd({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
#define LOW_PRECISION`),e}const Fg={[ur]:"SHADOWMAP_TYPE_PCF",[ps]:"SHADOWMAP_TYPE_VSM"};function Og(i){return Fg[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Bg={[Ti]:"ENVMAP_TYPE_CUBE",[Ki]:"ENVMAP_TYPE_CUBE",[Lr]:"ENVMAP_TYPE_CUBE_UV"};function kg(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Bg[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const zg={[Ki]:"ENVMAP_MODE_REFRACTION"};function Vg(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":zg[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Hg={[Dr]:"ENVMAP_BLENDING_MULTIPLY",[xh]:"ENVMAP_BLENDING_MIX",[bh]:"ENVMAP_BLENDING_ADD"};function Gg(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Hg[i.combine]||"ENVMAP_BLENDING_NONE"}function Wg(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function $g(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=Og(t),u=kg(t),d=Vg(t),m=Gg(t),f=Wg(t),p=Rg(t),v=Cg(r),E=s.createProgram();let _,g,S=t.glslVersion?"#version "+t.glslVersion+`
